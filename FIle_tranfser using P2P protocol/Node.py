...
class Node:
    ...
    def transferFile(self, connection, address, rDataList):  #yeh wala code
        ...
        print("Filesize greater than 1MB trying Chunking file")
    ...
    def start(self):
        ...
        while True:
            print("Waiting for other Networks to join")   
    ...
    def leaveNetwork(self):
        ...
        pSocket.close()
        print("Currently  availavable files :", self.filenameList)
        # And also replicating its files to succ as a client
        print("Provide Fault tolerance")
        ...
        for filename in self.filenameList:
            ...
            with open(filename, 'rb') as file:
                ...
                pSocket.close()
                print(" Succesfully File replicated")
            pSocket.close()
    ...
    def getSuccessor(self, address, keyID):
        ...
        #print(rDataList)     #Baar Baar Print ho raha 
    ...
    def Printfilelist(self):
        print("The currently files i have")
        for file in self.filenameList:
        	print(file)

    def printMenu(self):
        print("\n1. Join Hub\n2. Leave Hub\n3. Upload File\n4.Download File")
        print("5. Print Routing Table\n6. Print my previous and next\n 7.Show My Files")
